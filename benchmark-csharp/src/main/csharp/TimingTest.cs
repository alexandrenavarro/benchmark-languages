...
sealed class TimingTest
{
     ...
     * NB_CREATION_TESTS
     */
    private static int NB_TIMING_TESTS = 50 * 1000 * 1000;
    /**
    ...
    public static long testCurrentTime()
    {
        ...
        Console.WriteLine("[TimingTest], Invoke of " + NB_TIMING_TESTS + " DateTime currentTime = DateTime.Now,, snapshot time,"
    ...
    public static void main(string[] args)
    {
        ...
        executionTimes.Sort();
        Console.WriteLine("[TimingTest], Invoke of " + NB_TIMING_TESTS + " DateTime currentTime = DateTime.Now,, average time,"
